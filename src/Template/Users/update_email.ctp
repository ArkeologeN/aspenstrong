                             ...
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> 
                                       ...
                                       <div class="user_display_form user_display_form_vals">
                                       		...
                                       		<input type="email" class="required valid" name="new_email" value="<?php echo $user['user_email'];?>" required="required" id="new_password">
                                       </div>
                                 <div class="green_save">
                                       <ul>
                                           <li>
                                             <button type="submit" value="Submit" class="save_btn">Update</button>
                                           </li>
